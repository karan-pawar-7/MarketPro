          ...
          <div className="max-w-2xl">
            ...
            <FadeContent blur={true} duration={2000} easing="ease-out" initialOpacity={0}>
              <p className="mt-8 text-gray-300 text-lg leading-8 max-w-xl">
                ...
                positioning to paid media to SEO — so your business grows faster
            ...
            <FadeContent blur={true} duration={2000} easing="ease-out" initialOpacity={0}>
              <div className="flex flex-wrap gap-4 mt-10 mb-5">
                <button
                  ...
                  className="px-8 py-4 rounded-full bg-orange-500 hover:bg-orange-700 duration-300 text-white font-semibold shadow-lg shadow-orange-500/30 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-full border border-white/20 hover:border-orange-500 hover:text-orange-500 duration-300 text-white transition-all cursor-pointer"
                >
                  Explore Services →
                </button>
              </div>

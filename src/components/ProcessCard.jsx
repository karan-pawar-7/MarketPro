...
const ProcessCard = ({ item, darkMode }) => {
    const Icon = item.icon;

    return (
        <div
            className={`group relative overflow-hidden rounded-3xl border p-8 transition-all duration-500 hover:-translate-y-2 hover:border-orange-500 ${
                darkMode
        ...
        >
            ...
            {/* Step Number */}
            <span
                className={`absolute top-6 right-6 text-6xl font-bold transition duration-500 ${
                    darkMode
            ...
            {/* Icon */}
            <div className="relative z-10 w-16 h-16 rounded-2xl bg-orange-500/10 flex items-center justify-center text-3xl text-orange-500 transition duration-300 group-hover:bg-orange-500 group-hover:text-white">
                <Icon />
            </div>

            {/* Title */}
            <h2
                className={`relative z-10 mt-8 text-2xl font-bold ${
            ...
            {/* Description */}
            <p
                className={`relative z-10 mt-4 leading-7 ${
            ...
            {/* Footer */}
            <div
                className={`relative z-10 mt-8 flex items-center justify-between border-t pt-5 ${
                    darkMode
                        ? "border-white/10"
                        : "border-gray-200"
                }`}

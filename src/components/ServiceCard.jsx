...
//             {/* Background Glow */}
//             <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-orange-500/10 blur-3xl opacity-0 transition duration-500 group-hover:opacity-100 hover:-translate-y-2 hover:border-orange-500"></div>
...
const ServiceCard = ({ service, darkMode }) => {
    ...
    return (
        ...
        >
            ...
            {/* Description */}
            <p
                className={`relative z-10 leading-7 mb-8 ${
            ...
            {/* Bottom */}
            <div
                className={`relative z-10 flex items-center justify-between border-t pt-5 ${
